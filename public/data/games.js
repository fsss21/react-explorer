  ...
  words: [
    {
      id: 'h1',
      word: 'Сибиряков',
      clue: '1.Название ледокола, первым преодолевшего трассу Северного морского пути за одну навигацию',
    ...
    },
    {
      id: 'v2',
      word: 'льдина',
      clue: 'Отдельный кусок льда, дрейфующий на поверхности воды',
      direction: 'vertical',
      start: { row: 8, col: 16 },
      solved: false
    },
    {
      id: 'h3',
      word: 'Нобиле',
      clue: 'Фамилия руководителя арктической экспедиции к Северному полюсу на дирижабле «Италия» в 1928 году',
      direction: 'horizontal',
      start: { row: 8, col: 12 },
      solved: false
    },
    {
      id: 'v4',
      word: 'Арктика',
      clue: 'Географический район вокруг Северного полюса',
      direction: 'vertical',
      start: { row: 10, col: 19 },
      solved: false
    },
    {
      id: 'v5',
      word: 'ледокол',
      clue: 'Судно, способное преодолевать льды и обеспечивать проход грузов по ледяным морям',
      direction: 'vertical',
      start: { row: 3, col: 11 },
      solved: false
    },
    {
      id: 'h6',
      word: 'архипелаг',
      clue: 'Группа морских островов, расположенных по близости друг от друга',
      direction: 'horizontal',
      start: { row: 3, col: 5 },
      solved: false
    },
    {
      id: 'v7',
      word: 'Чухновский',
      clue: 'Советский лётчик, родоначальник ледовых разведок, участник операции по спасению членов экспедиции дирижабля «Италия» под руководством У.Нобиле в 1928 году',
      direction: 'vertical',
      start: { row: 1, col: 7 },
      solved: false
    },
    {
      id: 'h8',
      word: 'Челюскин',
      clue: 'Русский исследователь, открывший самую северную точку Евразии, которая теперь носит его имя',
      direction: 'horizontal',
      start: { row: 1, col: 6 },
      solved: false
    },
    {
      id: 'v9',
      word: 'Красин',
      clue: 'Название советского ледокола, принимавшего участие во спасении экспедиции под руководством У.Нобиле',
      direction: 'vertical',
      start: { row: 1, col: 5 },
      solved: false
    },
    {
      id: 'h10',
      word: 'дрейфующая',
      clue: 'станция «СП-1», так называется научно-исследовательская станция, создаваемая на льдах в глубоководной части Северного ледовитого океана',
      direction: 'horizontal',
      start: { row: 5, col: 11 },
      solved: false
    }
...
window.quizData = [
  ...
  {
    id: 3,
    question: 'Дирижабль, на котором экспедиция под руководством У.Нобиле совершила полёт со Шпицбергена к Северному полюсу:',
